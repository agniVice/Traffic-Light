...
public class GameState : MonoBehaviour, IInitializable
{
    ...
    public void FinishGame()
    {
        ...
        Camera.main.DOShakePosition(0.4f, 0.2f, fadeOut: true).SetUpdate(true).SetLink(Camera.main.gameObject);
        Camera.main.DOShakeRotation(0.4f, 0.2f, fadeOut: true).SetUpdate(true).SetLink(Camera.main.gameObject);
